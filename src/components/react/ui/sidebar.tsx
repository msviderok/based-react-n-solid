    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground p-0 [&>button]:hidden w-(--sidebar-width)!"
          style={
            {
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("gap-px flex w-full min-w-0 flex-col data-[mobile=true]:gap-1.5", className)}
      {...props}
    />
  );
}
...
function ToggleIcon(props: { className?: string }) {
  return (
    <svg
